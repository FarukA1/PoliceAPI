...
import kotlinx.android.synthetic.main.activity_february_report.*
import org.json.JSONArray
import org.json.JSONObject

class FebruaryReport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_february_report)

        layoutManager = LinearLayoutManager(this)


        februaryShoppingList.layoutManager = layoutManager
        adapter = RecyclerAdapter()
        februaryShoppingList.adapter = adapter
    ...
    fun getReport() {
        ...
        val url: String = "https://data.police.uk/api/crimes-at-location?date=2018-02&lat=52.629729&lng=-1.131592"
