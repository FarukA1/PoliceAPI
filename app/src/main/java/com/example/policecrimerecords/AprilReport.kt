...
import kotlinx.android.synthetic.main.activity_april_report.*
import org.json.JSONArray
import org.json.JSONObject

class AprilReport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_april_report)
        layoutManager = LinearLayoutManager(this)


        aprilShoppingList.layoutManager = layoutManager
        adapter = RecyclerAdapter()
        aprilShoppingList.adapter = adapter
...
//        val url: String = "https://api.github.com/search/users?q=eyehunt"
        val url: String = "https://data.police.uk/api/crimes-at-location?date=2018-04&lat=52.629729&lng=-1.131592"
